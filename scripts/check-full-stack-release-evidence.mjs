...
function inspectLocalReleaseSurface() {
  ...
  const requiredScripts = [
    ...
    "check:auth-provider-state-cleanup",
  ...
  const requiredFiles = [
    ...
    "docs/integrations/mochi-pets-website-contract.md",
    "docs/integrations/mochi-pets-website-contract.v1.schema.json",
