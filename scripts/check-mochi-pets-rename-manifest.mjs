...
assertIncludes("SiteHeader", siteHeader, `href: "${currentRoute}", label: "${currentPublicName}"`);
assertIncludes("SiteHeader", siteHeader, `const SOCIAL_HOST = "https://social.mochirii.com"`);
assertIncludes("SiteHeader", siteHeader, `label: "Social"`);
