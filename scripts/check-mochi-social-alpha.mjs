...
const checks = [
  ...
  },
  {
    ...
    includes: ['check:mochi-social-alpha', 'check:mochi-social-auth-bridge', 'check:mochi-social-bridge-state', 'check:mochi-social-browser-gates', 'check:mochi-social-discord-oauth', 'check:mochi-social-edge-authority', 'test:mochi-social-alpha', 'check:mochi-social-game-contract', 'check:mochi-social-preview-key-loader', 'check:mochi-social-preview-url', 'check:mochi-social-tester-password-gate', 'check:mochi-social-report-hygiene']
  },
  {
  ...
  },
  {
    ...
    includes: ['MOCHI_SOCIAL_SITE_BROWSER_GATES_CONFIRMED', 'MOCHI_SOCIAL_SITE_BROWSER_GATES_URL', 'MOCHI_SOCIAL_SITE_BROWSER_GATES_ACCESS_MODE', 'hosted browser gate confirmation requires', 'write-mochi-social-browser-gates.mjs', 'stored browser gate report', 'stored tester-password report', 'Stored Supabase report should fail the tester-password manual browser gate.', 'access mode supabase does not match current browser gate mode tester-password', 'Manual browser evidence should fail when the URL path is not /games/mochi-social.', 'stored browser gate report URL must target /games/mochi-social', 'fakeToken', 'site.bridge-state', 'check-mochi-social-bridge-state.mjs', 'site.auth-bridge', 'check-mochi-social-auth-bridge.mjs', 'site.preview-key-loader', 'check-mochi-social-preview-key-loader.mjs', 'site.discord-oauth-detector', 'check-mochi-social-discord-oauth-self-test.mjs', 'site.manual-browser-gates', 'Preview Ready should still remain red', ...browserGateEnvNames]
  },
  {
    file: 'scripts/write-mochi-social-browser-gates.mjs',
    includes: ['Mochi Social browser gate evidence passed', 'reports/mochi-social-browser-gates.json', 'reports/mochi-social-browser-gates.md', 'mochirii-mochi-social-browser-gates.md', 'This file is intentionally no-secret', 'MOCHI_SOCIAL_SITE_BROWSER_GATES_ALLOW_HOSTED', 'MOCHI_SOCIAL_SITE_BROWSER_GATES_NOTES', 'Access mode', 'browserGateEnvForMode', 'browserGateRouteFailure', 'browser gate review URL', 'must target /games/mochi-social', 'assertNoForbiddenMaterial', 'DISCORD_(?:CLIENT_SECRET|BOT_TOKEN)', ...browserGateEnvNames]
  },
  {
    file: 'scripts/check-mochi-social-report-hygiene.mjs',
    includes: ['Mochi Social report hygiene OK', 'reports/mochi-social-report-hygiene.json', 'reports/mochi-social-report-hygiene.md', 'reports/mochi-social-production-doorway.json', 'reports/mochi-social-production-doorway.md', 'mochirii-mochi-social-browser-gates.md', 'mochirii-mochi-social-preview-ready.md', 'mochirii-mochi-social-alpha-operator-next-steps.md', 'No secret values were printed', 'Wallet seed file reference', 'Account email', 'readGitState(root)']
  },
  {
