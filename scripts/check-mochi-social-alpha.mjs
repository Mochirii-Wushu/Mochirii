...
const browserGateEnvNames = [
  ...
  'MOCHI_SOCIAL_SITE_BROWSER_TESTER_ROUTE_SHEET_OK',
  'MOCHI_SOCIAL_SITE_BROWSER_TESTER_FEEDBACK_DRAFT_OK',
...
const checks = [
  ...
  },
  {
    ...
    includes: ['resolveMochiSocialGameRepoPath', 'MOCHI_SOCIAL_GAME_REPO_PATH', '../Mochi Social', '../Local RPG', 'resolveMochiSocialGameNodeModuleDirs', 'MOCHI_SOCIAL_PLAYWRIGHT_MODULE_DIR']
  },
  {
    file: 'scripts/prepare-mochi-social-alpha-operator-checklist.mjs',
    includes: ['Desktop', 'Creds', 'mochirii-mochi-social-alpha-operator-next-steps.md', 'This file is intentionally no-secret', 'MOCHI_SOCIAL_PREVIEW_ENV_FILE', 'readPreviewEnvFile', 'Local no-secret preview URL file', 'resolveMochiSocialGameRepoPath', 'NEXT_PUBLIC_MOCHI_SOCIAL_URL', 'MOCHI_SOCIAL_ALPHA_EDGE_URL', 'MOCHI_SOCIAL_ALPHA_AUTH_URL', 'MOCHI_SOCIAL_ALPHA_EDGE_PUBLISHABLE_KEY_FILE', 'MOCHI_SOCIAL_GAME_SERVER_TOKEN', 'Discord OAuth setup', 'site.discord-oauth', 'Alpha Preview Ready', 'configured-preview-stub', 'funded-chain gates', 'Do not set dummy', 'Local Branch Sync', 'Public-repo pushes are allowed', 'Push C:\\\\Users\\\\xtyty\\\\Documents\\\\Mochirii', ...browserGateEnvNames]
  },
  {
  ...
  },
  {
    ...
    includes: ['Localhost-only Mochi Social tester-password browser gate smoke', 'MOCHI_SOCIAL_SITE_BROWSER_GATES_LOCAL_URL', 'MOCHI_SOCIAL_SITE_BROWSER_GATES_GAME_URL', 'MOCHI_SOCIAL_SITE_BROWSER_GATES_TESTER_PASSWORD', 'resolveMochiSocialGameNodeModuleDirs', 'MOCHI_SOCIAL_PLAYWRIGHT_MODULE_DIR', 'MOCHI_SOCIAL_SITE_BROWSER_GATES_STAMP_REPORT', 'MOCHI_SOCIAL_READY', 'MOCHI_SOCIAL_AUTH_STATE', 'mochi_social_tester_access', 'Nearby:\\s*2 testers', 'configured-preview-stub/no-real-value', 'write-mochi-social-browser-gates.mjs']
  },
  {
