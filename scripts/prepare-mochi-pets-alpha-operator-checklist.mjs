...
const gameUrl = process.env.MOCHI_PETS_GAME_URL || process.env.NEXT_PUBLIC_MOCHI_PETS_URL || previewEnv.gameUrl || MOCHI_PETS_DEFAULT_ORIGIN;
...
const liveSiteUrl = process.env.MOCHI_PETS_SITE_PRODUCTION_URL || process.env.MOCHI_PETS_LIVE_SITE_URL || SITE_ORIGIN;
