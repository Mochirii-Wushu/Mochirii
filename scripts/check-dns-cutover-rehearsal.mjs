...
const requiredDocs = new Map([
  ...
  [
    ...
    [
      ...
      "prepare:live-member-cleanup-note",
      "check:live-member-cleanup-note",
      "check:live-member-workflow-result-packet",
  ...
  [
    ...
    [
      ...
      "prepare:live-member-cleanup-note",
      "prepare:dns-cutover-private-packets",
      "check:dns-cutover-approval-packet",
      "check:live-member-cleanup-note",
      "check:live-member-workflow-result-packet",
      "npm run check:dns-cutover-workstation",
      "npm run check:dns-cutover-pr-readiness",
...
const allowedCutoverFiles = new Set([
  ...
  "scripts/check-live-member-cleanup-note.mjs",
  "scripts/prepare-dns-cutover-private-packets.mjs",
  "scripts/prepare-live-member-cleanup-note.mjs",
