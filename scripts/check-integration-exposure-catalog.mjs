...
if (functions.size !== 49) fail(`Edge Function catalog must contain exactly 49 entries, found ${functions.size}`);
...
if (verifyJwtTrue !== 31 || verifyJwtFalse !== 18) {
  fail(`Edge Function JWT split must remain 31 true / 18 false, found ${verifyJwtTrue}/${verifyJwtFalse}`);
}
