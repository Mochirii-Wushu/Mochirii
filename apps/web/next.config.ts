...
const contentSecurityPolicy = [
  ...
  `frame-src 'self' https://discord.com https://open.spotify.com https://challenges.cloudflare.com https://hcaptcha.com https://*.hcaptcha.com ${mochiSocialOrigin}`,
  `connect-src 'self' https://*.supabase.co wss://*.supabase.co https://discord.com https://cdn.discordapp.com https://vitals.vercel-insights.com https://challenges.cloudflare.com https://hcaptcha.com https://*.hcaptcha.com ${mochiSocialOrigin}`,
