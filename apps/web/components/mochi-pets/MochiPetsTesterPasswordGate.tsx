...
export function MochiPetsTesterPasswordGate({ error }: { error: TesterGateError }) {
  ...
  return (
    <section className="mochi-game-shell mochi-game-shell--locked" aria-label="Mochi Pets tester access">
      ...
      <div className="mochi-game-preview-contract mochi-game-preview-contract--locked" aria-label="Mochi Pets preview contract">
      ...
      <aside className="mochi-game-panel mochi-gate-notes" aria-label="Mochi Pets access notes">
        <section>
