...
| --- | --- | --- | --- | --- | --- | --- |
| E01 | `docs/live-member-test-account-setup-runbook` | In progress | Pending | Pending | None | E02 |
| E02 | `chore/live-member-qa-local-template` | Pending | Pending | Pending | Requires E01 merge | E03 |
...
- Next item: E02 `chore/live-member-qa-local-template` after E01 PR merge and post-merge validation.
