...
- Website/social split: `https://mochirii.com` is the public information site. Header Social should stay in the regular Guild dropdown, footer Social should hand off directly to `https://social.mochirii.com`, and the website `/social` route is a protected Social Status helper for account-link/profile-visibility support.
