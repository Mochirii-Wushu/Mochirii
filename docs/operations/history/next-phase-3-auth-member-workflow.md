...
> Historical migration record. The root static source has been retired; current
> deployment and rollback guidance lives in `docs/operations/deployment.md`.
...
See `docs/operations/deployment.md` for the current rollback and provider-change checklist.
